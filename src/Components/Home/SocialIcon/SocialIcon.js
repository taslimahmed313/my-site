...
const SocialIcon = () => {
    return (
      <div className="top-[300px] fixed  morphy rounded-xl px-2 py-5">
        <a href="https://github.com/taslimahmed313">
          <FaGithub className=" hover:text-[#64ffda] hover:-translate-y-1  hover:scale-125 duration-500 text-white  text-xl"></FaGithub>{" "}
        </a>{" "}
        <br />
        ...
        <a href="https://www.linkedin.com/in/taslim-ahmed-020962250/">
          <FaFacebook className=" hover:text-[#64ffda] hover:-translate-y-1  hover:scale-125 duration-500 text-white text-xl"></FaFacebook>
        </a>{" "}
        <br />
